export const exampleContent = `# Markdown语法学习
...
![](https://img.shetu66.com/2023/04/27/1682575881230001.png)
...
$LaTeX$ 公式是一块很大的内容。这里只展示 $LaTeX$ 公式在Archive Markdown Editor的呈现效果。
...
Mermaid也是一块很大的内容，这里只展示Mermaid在Archive Markdown Editor的呈现效果。
